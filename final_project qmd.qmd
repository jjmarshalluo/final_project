...
## Peer review notes: fixed typo in YAML (imbed --> embed) :)
## Also: Your code ran top to bottom! I added some spaces throughout but overall the structure is really clean
...
## Peer review notes: readr and ggplot are in tidyverse so you technically don't need to load them too :)
...
## Peer review note: Looks great! You could also use "slice_max" to select the top 3 rather than doing it manually, in case you ever wanted to adapt the code for another year or something.
...
## Peer review note: you create "avgsales" in the above code chunk and also toward the beginning of the script so you could take one out without breaking the code :)
...
## Peer review note: Your plot looks really great. You could also play around with "span" to make your LOESS lines look a little less wiggly:
