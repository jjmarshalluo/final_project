...
#REVIEW: This obj name 'avgsales' is also used earlier for a slightly different one. 
#To avoid confusion, using a more specific name 'avgsales_plot' would also be nice.
avgsales |>
...
#REVIEW: Adding interpretation would also make it easy to understand the graphs
# From 2014 to 2024, Silver and black had the highest average sales volume, followed by blue. However, white had the lowest sales most of the years. This indicates consistant long-term consumer preference for certain car colors.
```
